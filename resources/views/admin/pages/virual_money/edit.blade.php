    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Cập nhật đông: <span class="text-danger font-italic">{{ $virualMoney->name }}</span></h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
        ...
        <!-- /.content-header -->
        <form role="form" action="{{ url('/admin/tien-ao/' . $virualMoney->id . '/edit') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="ten" name="name" value="{{ $virualMoney->name }}">
                            </div>

                            <div class="form-group">
                                <label for="ten">Mã <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="code" name="code" value="{{ $virualMoney->code }}">
                            </div>
                            <!-- /.card-body -->
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="buy" name="buy" value="{{ $virualMoney->buy }}">
                            </div>
                            <div class="form-group">
                                <label for="sell">Giá bán theo ngày <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="sell" name="sell" value="{{ $virualMoney->sell }}">
                            </div>
                            <div class="form-group">
                                <label for="image">Icon hình ảnh <span class="text-danger">*</span></label>
                                <input type="file" class="form-control" id="image" name="image">
                                <br>
                                <img style="width: 64px; height: 64px;" src="{{ asset('/image/virual_money/' . $virualMoney->image) }}" alt="{{ $virualMoney->name }}">
                            </div>
                        </div>
                        <!-- /.card-body -->
                        <div class="card-footer">
