...
@section('content')
    <div class="content-wrapper">
        ...
        <!-- /.content-header -->
        <form role="form" action="{{ url('/admin/tin-tuc/create') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="text" readonly class="form-control" id="slug" name="slug" placeholder="">
                                    </div>
                                </div>
                                <!-- /.card-body -->
                                <div class="card-footer">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="text" readonly class="form-control" id="time_public" name="time_public" value="{{ \Carbon\Carbon::now()->format('d-m-Y') }}">
                                    </div>
                                </div>
                                <!-- /.card-body -->
                                <div class="card-footer">
